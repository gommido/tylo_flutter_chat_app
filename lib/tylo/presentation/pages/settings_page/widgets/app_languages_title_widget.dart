...
class AppLanguagesTitleWidget extends StatelessWidget {
  const AppLanguagesTitleWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return CustomGestureDetector(
      onTap: (){
        pushNamed(route: AppRoutes.appLanguagePage, context: context);
      },
      child: CustomContainer(
        ...
        child: CustomRow(
          children: [
            ...
            CustomText(
              data: translate(context, AppStrings.appLanguages),
